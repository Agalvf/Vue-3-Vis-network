...
export default {
  ...
  methods: {
    ...
    imprimirCanvas() {
      ...
      windows.open(canvas.toDataURL("image/png"))
    },
    importarDatos(){
  ...
  <div class="d-flex w-100 h-100 mx-auto flex-column page">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <li>
                    <button class="dropdown-item" type="button" @click ="guardar()">Guardar</button>
                  </li>
                  <li>
          ...
          <div class="d-flex align-items-center">
            ...
            <!-- Notifications -->
            <div class="dropdown">
              <a id="navbarDropdownMenuLink" class="text-reset me-3 dropdown-toggle hidden-arrow" href="#" role="button"
    ...
    <section>
      <ul class="nav nav-pills justify-content-center">
        <li class="nav-item">
          <button id="botones" class="btn" type="button" @click="añadirNodo()">
            Añadir nodo
          </button>
        </li> 
        <li class="nav-item">
          <button id="botones" class="btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
            @click="añadirArista()">
            Añadir arista
          </button>
        </li>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="container-fluid">
              <div class="row">
                <div class="col">
                  <p>Origen <input type="text" /></p>
                </div>
                <div class="col">
                  <p>Destino: <input type="text" /></p>
                </div>
              </div>
              <div class="row">
                <div class="col">
